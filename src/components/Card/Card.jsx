...
const Card = () => {
  ...
  return (
    <div className="bg-c-dark my-5 p-10 rounded-[25px]">
      <div className="text-center w-full h-full">
        <div>
          <img
            className="rounded-[25px] mb-5 w-full"
            src={tracks[currentTrack].coverSrc}
            alt="cover de musica"
          />
          <h1 className="text-3xl text-c-white">
            {tracks[currentTrack].title}
          </h1>
          <p className="text-c-gray text-xl my-2">
        ...
        <div className="mt-6 flex justify-center items-center">
          <div className="w-full">
            ...
            <div className="relative w-full h-1 rounded-lg overflow-hidden">
              <div
                ref={progressBarRef}
                className="absolute top-0 left-0 h-full bg-c-pink"
              ></div>
            </div>
